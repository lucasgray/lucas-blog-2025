---
title: ExecVision
summary: Call analysis and coaching
tags: ['startups', 'react', 'kotlin']
draft: false
layout: PostSimple
date: '2018-01-01'
---
...
![Ev sales clipart](/static/images/execvision/ev.png)

I worked at [ExecVision](https://www.execvision.io/) from 2018-2021 as the engineering manager (later engineering director) for the product team. As a remote first team with senior developers, we were a high output team with a blissfully meeting free calendar.
...
[![Pure video call card](/static/images/execvision/pure-video-call-card.png)](/static/images/execvision/pure-video-call-card.png)
...
[![Triggers call card](/static/images/execvision/triggers-call-card.png)](/static/images/execvision/triggers-call-card.png)
