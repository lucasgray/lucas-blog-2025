---
title: Beekeeper
summary: An early stage data focused startup (2015-2017)
tags: ['scala', 'big data', 'startups']
draft: false
layout: PostSimple
date: '2015-01-01'
---

![beekeeper logo](/static/images/beekeeper/beekeeper.png)
...
Our main product focus for quite a while was automatic emailed reports, and while email is a very difficult medium to really create anything presentable, our reports looked decent.

![market station](/static/images/beekeeper/market-station.png)
